...
//		[NonSerialized]
		...
		protected internal virtual void DrawNode()
		{
            ...
            GUIStyle headGuiStyle = NodeEditor.curEditorState.selectedNode == this ? NodeEditorGUI.nodeBoxBold : NodeEditorGUI.nodeBox;
            headGuiStyle.normal.textColor = headColor;
            GUI.Label(headerRect, name, headGuiStyle);
